...
<h3  style="padding:30px 50px;"> 欢迎：${teacher.getTname()}  老师登录系统</h3>
</div>
...
<div id="mainbody">
    ...
    <div class="box1" >操作选项</div>
      ...
      <p> 
        <a href="manage?mainPage=showTC" class="box3" style="text-decoration:none"><span>授课查询</span></a></p>
      <p>
        <a href="manage?mainPage=grade" class="box3" style="text-decoration:none"><span>课程评分</span></a></p>
      <p>
        <a href="manage?mainPage=updatePwdTea" class="box3" style="text-decoration:none"><span>修改密码</span></a></p>
      <p>      
      <a href="manage?mainPage=updateTeacherTea" class="box3" style="text-decoration:none"><span>个人信息</span></a>
      </p>
      <p> 
