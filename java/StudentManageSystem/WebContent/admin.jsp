...
<h3  style="padding:30px 50px;"> 欢迎：${admin.getAname()}  登录系统</h3>
</div>
...
<div id="mainbody">
    ...
    <div class="box1"  >操作选项</div>
      ...
      <p> 
        <a href="manage?mainPage=showAllCourse" class="box3" style="text-decoration:none"><span>课程管理</span></a></p>
      <p>
        <a href="manage?mainPage=operateStudent" class="box3" style="text-decoration:none"><span>学生管理</span></a></p>
      <p>
        <a href="manage?mainPage=operateTeacher" class="box3" style="text-decoration:none"><span>教师管理</span></a></p>
