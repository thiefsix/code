...
<body>
	...
	%>
	<form action="student?type=update" method="post">
		<table class="customers" align="center">
		<tr class="alt">
			<td>
				学号：<input type="text" name="sno" value="<%= student.getSno() %>" readonly="true">
			</td>
		</tr>
		<tr class="alt">
			<td>
				姓名：<input type="text" name="sname" placeholder="<%= student.getSname() %>">
			</td>
		</tr>
		<tr class="alt">
			<td>
		...
		<tr class="alt">
			<td>
				出生日期：<input type="text" name="sbirthday" placeholder="<%= student.getSbirthday() %>">
			</td>
		</tr>
		<tr class="alt">
			<td>
				入学时间：<input type="text" name="senttime" placeholder="<%= student.getSenttime() %>">
			</td>
		</tr>
		<div>
		<tr class="alt">
